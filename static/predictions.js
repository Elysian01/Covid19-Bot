...
function start_chotbot() {
    ...
    next_answer = '<div class="msg-bubble"><div class="msg-text" id="age-text"> AGE<input type="number" id="age-input" class="form-control" aria-describedby="passwordHelpBlock"><button type="button" class="btn btn-primary" id="age_go_button" onclick="age()">Go!</button></div></div>';
...
function main_result() {
    ...
    if (corona_number >= 0 && corona_number <= 2) {
        next_answer = "<div class='msg-bubble'><div class='msg-text'>Maybe Stress related and observe</div></div>";
        document.getElementById("main_result").innerHTML += next_answer;
    } else if (corona_number >= 3 && corona_number <= 5) {
        next_answer = "<div class='msg-bubble'><div class='msg-text'>Hydrate properly and proper personal hygiene.Observe and re-evaluate after 2 days </div></div>";
        document.getElementById("main_result").innerHTML += next_answer;
    } else if (corona_number >= 3 && corona_number <= 5) {
        next_answer = "<div class='msg-bubble'><div class='msg-text'>Seek a consultation with your doctor </div></div>";
        document.getElementById("main_result").innerHTML += next_answer;
    } else {
        next_answer = "<div class='msg-bubble'><div class='msg-text'>Call the DOH hotline 02-8-561-7800 </div></div>";
        document.getElementById("main_result").innerHTML += next_answer;
    }
}
